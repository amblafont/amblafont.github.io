...
var $author$project$Format$Version2$toEdgeLabel = function (_v0) {
	var label = _v0.label;
	var style = _v0.style;
	return {
...
var $author$project$Format$Version2$toNodeLabel = function (_v0) {
	var pos = _v0.pos;
	var label = _v0.label;
	return {dims: $elm$core$Maybe$Nothing, label: label, pos: pos, selected: false};
};
var $author$project$Format$Version2$fromJSGraph = function (_v0) {
	var nodes = _v0.nodes;
	var edges = _v0.edges;
	return A3(
		$author$project$Polygraph$map,
		function (_v1) {
			return $author$project$Format$Version2$toNodeLabel;
		},
		function (_v2) {
			return $author$project$Format$Version2$toEdgeLabel;
		},
		A2($author$project$Polygraph$fromNodesAndEdges, nodes, edges));
};
var $author$project$Format$LastVersion$fromJSGraph = $author$project$Format$Version2$fromJSGraph;
...
var $author$project$Format$Version2$fromEdgeLabel = function (_v0) {
	var label = _v0.label;
	var style = _v0.style;
	return {
		label: label,
...
var $author$project$Format$Version2$fromNodeLabel = function (_v0) {
	var pos = _v0.pos;
	var label = _v0.label;
	return {label: label, pos: pos};
};
var $author$project$Format$Version2$toJSGraph = function (g) {
	var gjs = $author$project$Polygraph$normalise(
		A3(
			$author$project$Polygraph$map,
			function (_v0) {
				return $author$project$Format$Version2$fromNodeLabel;
			},
			function (_v1) {
				return $author$project$Format$Version2$fromEdgeLabel;
			},
			g));
...
var $author$project$Format$LastVersion$toJSGraph = $author$project$Format$Version2$toJSGraph;
...
var $author$project$ArrowStyle$prevInList = F2(
	function (l, a) {
		prevInList:
		while (true) {
			if (!l.b) {
...
var $author$project$ArrowStyle$nextInList = F2(
	function (l, a) {
		return A2(
			$author$project$ArrowStyle$prevInList,
...
var $author$project$ArrowStyle$toggleHead = function (s) {
	return _Utils_update(
		...
		{
			head: A2(
				$author$project$ArrowStyle$nextInList,
				_List_fromArray(
...
var $author$project$Main$graphCutHead = F3(
	function (id, head, m) {
		var pos = m.mousePos;
		return A2(
			$elm$core$Maybe$withDefault,
			...
			A2(
				...
				function (e) {
					return A2(
						$elm$core$Maybe$map,
						function (nto) {
							var g1 = A2($author$project$Polygraph$removeEdge, id, m.graph);
							var label = _Utils_update(
								nto,
								{pos: pos});
							var _v0 = A2($author$project$Polygraph$newNode, g1, label);
							var g2 = _v0.a;
							var newId = _v0.b;
							var _v1 = head ? _Utils_Tuple2(e.from, newId) : _Utils_Tuple2(newId, e.to);
							var n1 = _v1.a;
							var n2 = _v1.b;
							var _v2 = A4($author$project$Polygraph$newEdge, g2, n1, n2, e.label);
							var g3 = _v2.a;
...
var $author$project$Main$update_CutHead = F4(
	function (id, head, msg, m) {
		var finalise = function (_v1) {
			return _Utils_Tuple2(
				_Utils_update(
					m,
					{
						graph: A3($author$project$Main$graphCutHead, id, head, m),
						mode: $author$project$Modes$DefaultMode
					}),
				$elm$core$Platform$Cmd$none);
		};
				...
				case 'KeyChanged':
					if (!msg.a) {
						if (msg.c.$ === 'Control') {
							...
							if ('c' === msg.c.a.valueOf()) {
								return _Utils_Tuple2(
									_Utils_update(
										m,
										{
											mode: A2($author$project$Modes$CutHead, id, !head)
										}),
									$elm$core$Platform$Cmd$none);
							} else {
								break _v0$4;
...
var $author$project$GraphProof$getDiagrams = F2(
	function (g, edges) {
		if (!edges.b) {
			return _List_Nil;
		} else {
...
var $author$project$GraphProof$getAllValidDiagrams = function (g) {
	...
	var edgesR = A2(
		$elm$core$List$map,
		function (e) {
			return _Utils_Tuple2(e, true);
		},
		edges);
	var edgesL = A2(
		$elm$core$List$map,
		function (e) {
			return _Utils_Tuple2(e, false);
		},
		edges);
...
var $author$project$Geometry$Point$countRounds = function (l) {
	return $elm$core$Basics$round(
		$author$project$Geometry$Point$sumAngles(l) / (2 * $elm$core$Basics$pi));
};
...
var $author$project$Modes$SplitArrow$initialise = function (m) {
	var _v0 = $author$project$GraphDefs$selectedEdgeId(m.graph);
	if (_v0.$ === 'Nothing') {
...
var $author$project$Main$pasteGraphAction = F2(
	function (model, g) {
		var od = $author$project$GraphDefs$selectedIncompleteDiagram(model.graph);
		var diags = $author$project$GraphProof$getAllValidDiagrams(
...
var $author$project$Geometry$Point$isInPoly = F2(
	function (pos, l) {
		...
		return $author$project$Geometry$Point$countRounds(anglesLoop) === 1;
	});
	...
	function (pos, gi) {
		...
		var d = A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$elm$core$Tuple$first,
				$author$project$Geometry$Point$isInPoly(pos)),
			diags);
		var gf = A2(
			$elm$core$Maybe$map,
			A2(
	...
	function (msg, model) {
		...
		while (true) {
			switch (msg.$) {
				...
				case 'PasteGraph':
					var g = msg.a;
					return A2($author$project$Main$pasteGraphAction, model, g);
				case 'KeyChanged':
					if (!msg.a) {
						if (msg.c.$ === 'Control') {
							if (msg.c.a === 'Delete') {
							...
							switch (msg.c.a.valueOf()) {
								...
								case 'p':
									var _v3 = A2(
										$author$project$Polygraph$newNode,
										model.graph,
										A2($author$project$GraphDefs$newNodeLabel, model.mousePos, ''));
									var newGraph = _v3.a;
									var newId = _v3.b;
									var newModel = A3(
										$author$project$Model$addOrSetSel,
...
var $author$project$Main$enlargeGraph = F2(
	function (m, orig) {
		var _v0 = A2($author$project$Geometry$Point$subtract, m.mousePos, orig);
		var ox = _v0.a;
		var oy = _v0.b;
		var _v1 = orig;
		var xi = _v1.a;
		...
		var mkp = F3(
			function (n, i, o) {
				return (_Utils_cmp(n, i) > -1) ? (n + o) : n;
			});
		var mapNode = function (n) {
			var _v2 = n.pos;
			var nx = _v2.a;
			var ny = _v2.b;
			return _Utils_update(
		...
		var g = A3(
			$author$project$Polygraph$map,
			$elm$core$Basics$always(mapNode),
			$elm$core$Basics$always($elm$core$Basics$identity),
			m.graph);
		return g;
	});
				...
				case 'MouseUp':
					return $author$project$Model$switch_Default(
						_Utils_update(
							model,
							{
								graph: A2($author$project$Main$enlargeGraph, model, orig)
							}));
				default:
					break _v0$2;
			}
...
var $author$project$Format$Version2$version = 2;
var $author$project$Format$LastVersion$version = $author$project$Format$Version2$version;
var $author$project$Main$update = F2(
	function (msg0, modeli) {
		var model = function () {
			switch (msg0.$) {
				case 'FileName':
					var s = msg0.a;
		...
		var msg = function () {
			if (msg0.$ === 'KeyChanged') {
				if (((!msg0.a) && (msg0.c.$ === 'Control')) && (msg0.c.a === 'Escape')) {
					return msg0;
				} else {
					return model.mouseOnCanvas ? msg0 : $author$project$Msg$noOp;
				}
			} else {
				return msg0;
			}
		...
		switch (msg.$) {
					...
					$author$project$Main$saveGraph(
						{
							...
							graph: $author$project$Format$LastVersion$toJSGraph(model.graph),
			...
			case 'Loaded':
				...
				return $author$project$Model$noCmd(
					_Utils_update(
						model,
						{fileName: fileName, graph: g, mode: $author$project$Modes$DefaultMode}));
			case 'FindReplace':
				var req = msg.a;
				return $author$project$Model$noCmd(
					A2(
		...
		return $author$project$Drawing$group(
			_List_fromArray(
				[
					...
					label.style,
					q),
					A4($author$project$GraphDrawing$segmentLabel, q, edgeId, label, curve)
				]));
	});
	...
	var g = A5(
		...
		F4(
			function (id, n1, n2, e) {
				...
				return {
					drawing: A4($author$project$GraphDrawing$edgeDrawing, id, e, q, e.style.bend),
					posDims: {
						dims: A2(
							$author$project$Geometry$Point$resize,
							4,
...
var $author$project$Modes$NewArrow$help = '[ESC] cancel, [click, TAB] name the point (if new), ' + ('[hjkl] position the new point with the keyboard, ' + ('[RET] terminate the arrow creation, ' + ('[\"' + ($author$project$ArrowStyle$controlChars + ('\"] alternate between different arrow styles, ' + '[i]nvert arrow.')))));
...
var $author$project$Main$helpMsg = function (model) {
	...
	switch (_v0.$) {
		...
		case 'CutHead':
			return msg('Mode cut arrow.' + (' [RET] or [click] to confirm, [ctrl] to merge the endpoint with existing node. [ESC] to cancel. ' + '[c] to switch between head/tail.'));
		case 'RenameMode':
